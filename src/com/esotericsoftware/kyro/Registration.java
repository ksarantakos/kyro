...
public class Registration {
	...
	public void setSerializer (Serializer serializer) {
		if (serializer == null) throw new IllegalArgumentException("serializer cannot be null.");
		this.serializer = serializer;
		if (TRACE) trace("kyro", "Update registered serializer: " + type.getName() + " (" + serializer.getClass().getName() + ")");
	}
	...
	/** Sets the instantiator that will create a new instance of the type in {@link Kyro#newInstance(Class)}. */
