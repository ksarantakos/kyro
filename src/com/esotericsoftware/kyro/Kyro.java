...
import com.esotericsoftware.kyro.factories.PseudoSerializerFactory;
import com.esotericsoftware.kyro.factories.ReflectionSerializerFactory;
import com.esotericsoftware.kyro.factories.SerializerFactory;
...
import com.esotericsoftware.kyro.serializers.DefaultArraySerializers.BooleanArraySerializer;
import com.esotericsoftware.kyro.serializers.DefaultArraySerializers.ByteArraySerializer;
import com.esotericsoftware.kyro.serializers.DefaultArraySerializers.CharArraySerializer;
import com.esotericsoftware.kyro.serializers.DefaultArraySerializers.DoubleArraySerializer;
import com.esotericsoftware.kyro.serializers.DefaultArraySerializers.FloatArraySerializer;
...
import com.esotericsoftware.kyro.serializers.DefaultArraySerializers.ShortArraySerializer;
import com.esotericsoftware.kyro.serializers.DefaultArraySerializers.StringArraySerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.BigDecimalSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.BigIntegerSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.BooleanSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.ByteSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CalendarSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CharSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.ClassSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CollectionsEmptyListSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CollectionsEmptyMapSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CollectionsEmptySetSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CollectionsSingletonListSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CollectionsSingletonMapSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CollectionsSingletonSetSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.CurrencySerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.DateSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.DoubleSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.EnumSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.EnumSetSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.FloatSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.IntSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.KryoSerializableSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.LocaleSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.LongSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.ShortSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.StringBufferSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.StringBuilderSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.StringSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.TimeZoneSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.TreeMapSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.TreeSetSerializer;
import com.esotericsoftware.kyro.serializers.DefaultSerializers.VoidSerializer;
import com.esotericsoftware.kyro.util.DefaultClassResolver;
import com.esotericsoftware.kyro.util.DefaultStreamFactory;
import com.esotericsoftware.kyro.util.FastestStreamFactory;
import com.esotericsoftware.kyro.util.IdentityMap;
import com.esotericsoftware.kyro.util.IntArray;
import com.esotericsoftware.kyro.util.MapReferenceResolver;
import com.esotericsoftware.kyro.util.ObjectMap;
import com.esotericsoftware.kyro.util.Util;
...
public class Kyro {
	...
	/** Tells if ASM-based backend should be used by new serializer instances created using this Kyro instance. */
	private boolean asmEnabled = false;

	private StreamFactory streamFactory;

	/** Creates a new Kyro with a {@link DefaultClassResolver} and a {@link MapReferenceResolver}. */
	public Kyro () {
		this(new DefaultClassResolver(), new MapReferenceResolver(), new DefaultStreamFactory());
	}

	/** Creates a new Kyro with a {@link DefaultClassResolver}.
	 * @param referenceResolver May be null to disable references. */
	public Kyro (ReferenceResolver referenceResolver) {
		this(new DefaultClassResolver(), referenceResolver, new DefaultStreamFactory());
	}

	/** @param referenceResolver May be null to disable references. */
	public Kyro (ClassResolver classResolver, ReferenceResolver referenceResolver) {
		this(classResolver, referenceResolver, new DefaultStreamFactory());
	}

	/** @param referenceResolver May be null to disable references. */
	public Kyro (ClassResolver classResolver, ReferenceResolver referenceResolver, StreamFactory streamFactory) {
		...
		addDefaultSerializer(KyroSerializable.class, KryoSerializableSerializer.class);
	 ...
	 * {@link ReflectionSerializerFactory#makeSerializer(Kyro, Class, Class)}. By default, the following classes have a default
	 * serializer set:
	 * <p>
	 * <table>
	 * <tr>
	 ...
	 * method to customize behavior. The default implementation calls {@link SerializerFactory#makeSerializer(Kyro, Class)} using
	...
	/** Registers the class using the lowest, next available integer ID and the {@link Kyro#getDefaultSerializer(Class) default
	...
	/** Registers the class using the specified ID and the {@link Kyro#getDefaultSerializer(Class) default serializer}. If the ID is
	 * already in use by the same type, the old entry is overwritten. If the ID is already in use by a different type, a
	 * {@link KyroException} is thrown. Registering a primitive also affects the corresponding primitive wrapper.
	 * <p>
	 ...
	 * overwritten. If the ID is already in use by a different type, a {@link KyroException} is thrown. Registering a primitive
	 ...
	 * already in use by a different type, a {@link KyroException} is thrown. Registering a primitive also affects the
	 ...
	 * {@link Kyro#getRegistration(Class)}. */
	...
	public int getNextRegistrationId () {
		...
		throw new KyroException("No registration IDs are available.");
	}

	/** If the class is not registered and {@link Kyro#setRegistrationRequired(boolean)} is false, it is automatically registered
	 * using the {@link Kyro#addDefaultSerializer(Class, Class) default serializer}.
	 * @throws IllegalArgumentException if the class is not registered and {@link Kyro#setRegistrationRequired(boolean)} is true.
			...
			if (registration == null) {
				if (registrationRequired) {
					throw new IllegalArgumentException("Class is not registered: " + className(type)
						+ "\nNote: To register this class use: kyro.register(" + className(type) + ".class);");
				}
	...
	boolean writeReferenceOrNull (Output output, Object object, boolean mayBeNull) {
		...
		if (!referenceResolver.useReferences(object.getClass())) {
			if (mayBeNull) output.writeVarInt(Kyro.NOT_NULL, true);
			return false;
		}
		...
		if (id != -1) {
			if (DEBUG) debug("kyro", "Write object reference " + id + ": " + string(object));
		...
		if (TRACE) trace("kyro", "Write initial object reference " + id + ": " + string(object));
		return false;
	}
	...
	int readReferenceOrNull (Input input, Class type, boolean mayBeNull) {
		...
		if (id == NOT_NULL) {
			...
			if (TRACE) trace("kyro", "Read initial object reference " + id + ": " + className(type));
		...
		if (DEBUG) debug("kyro", "Read object reference " + id + ": " + string(readObject));
		return REF;
	}

	/** Called by {@link Serializer#read(Kyro, Input, Class)} and {@link Serializer#copy(Kyro, Object)} before Kyro can be used to
	 * deserialize or copy child objects. Calling this method is unnecessary if Kyro is not used to deserialize or copy child
	 * objects.
	 * @param object May be null, unless calling this method from {@link Serializer#copy(Kyro, Object)}. */
	...
	public void reset () {
		...
		if (TRACE) trace("kyro", "Object graph complete.");
	}

	/** Returns a deep copy of the object. Serializers for the classes involved must support {@link Serializer#copy(Kyro, Object)}.
	 * @param object May be null. */
	public <T> T copy (T object) {
		...
		try {
			...
			Object copy;
			if (object instanceof KyroCopyable)
				copy = ((KyroCopyable)object).copy(this);
			else
	 ...
	 * {@link Serializer#copy(Kyro, Object)}.
	 * @param object May be null. */
	...
	private void beginObject () {
		if (DEBUG) {
			if (depth == 0)
				...
				throw new ConcurrentModificationException("Kyro must not be accessed concurrently by multiple threads.");
		}
		if (depth == maxDepth) throw new KyroException("Max depth exceeded: " + depth);
		depth++;
	}
	...
	/** Sets the classloader to resolve unregistered class names to classes. The default is the loader that loaded the Kyro class. */
	...
	public void setRegistrationRequired (boolean registrationRequired) {
		...
		if (TRACE) trace("kyro", "Registration required: " + registrationRequired);
	}
	...
	public boolean setReferences (boolean references) {
		...
		if (TRACE) trace("kyro", "References: " + references);
		return !references;
	}
	...
	public void setReferenceResolver (ReferenceResolver referenceResolver) {
		...
		this.referenceResolver = referenceResolver;
		if (TRACE) trace("kyro", "Reference resolver: " + referenceResolver.getClass().getName());
	}
	...
	public void pushGenericsScope (Class type, Generics generics) {
		if (TRACE) trace("kyro", "Settting a new generics scope for class " + type.getName() + ": " + generics);
	...
	/** Tells Kyro, if ASM-based backend should be used by new serializer instances created using this Kyro instance. Already
	 * existing serializer instances are not affected by this setting.
	 * 
	 * <p>
	 * By default, Kyro uses ASM-based backend.
	 * </p>
	 * 
		...
		public ObjectInstantiator newInstantiatorOf (final Class type) {
						...
						return new ObjectInstantiator() {
							public Object newInstance () {
								try {
									...
									throw new KyroException("Error constructing instance of class: " + className(type), ex);
								}
							}
						};
			...
			if (fallbackStrategy == null) {
				if (type.isMemberClass() && !Modifier.isStatic(type.getModifiers()))
					throw new KyroException("Class cannot be created (non-static member class): " + className(type));
				else
					throw new KyroException("Class cannot be created (missing no-arg constructor): " + className(type));
			}
			// InstantiatorStrategy.
