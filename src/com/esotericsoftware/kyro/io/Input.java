...
public class Input extends InputStream {
	...
	public void skip (int count) throws KyroException {
	...
	protected int fill (byte[] buffer, int offset, int count) throws KyroException {
	 ...
	 * @throws KyroException if EOS is reached before required bytes are read (buffer underflow). */
	protected int require (int required) throws KyroException {
		int remaining = limit - position;
		if (remaining >= required) return remaining;
		if (required > capacity) throw new KyroException("Buffer too small: capacity: " + capacity + ", required: " + required);

		int count;
		// Try to fill the buffer.
		if (remaining > 0) {
			count = fill(buffer, limit, capacity - limit);
			if (count == -1) throw new KyroException("Buffer underflow.");
			remaining += count;
		...
		while (true) {
			...
			if (count == -1) {
				...
				throw new KyroException("Buffer underflow.");
			}
			remaining += count;
	...
	private int optional (int optional) throws KyroException {
		int remaining = limit - position;
	...
	public int read () throws KyroException {
	 ...
	 * read. */
	public int read (byte[] bytes) throws KyroException {
	...
	public int read (byte[] bytes, int offset, int count) throws KyroException {
		if (bytes == null) throw new IllegalArgumentException("bytes cannot be null.");
	...
	/** Discards the specified number of bytes. */
	public long skip (long count) throws KyroException {
	...
	public int readByteUnsigned () throws KyroException {
		require(1);
		return buffer[position++] & 0xFF;
	}

	/** Reads the specified number of bytes into a new byte[]. */
	public byte[] readBytes (int length) throws KyroException {
	...
	public void readBytes (byte[] bytes) throws KyroException {
		readBytes(bytes, 0, bytes.length);
	}

	/** Reads count bytes and writes them to the specified byte[], starting at offset. */
	public void readBytes (byte[] bytes, int offset, int count) throws KyroException {
		if (bytes == null) throw new IllegalArgumentException("bytes cannot be null.");
		int copyCount = Math.min(limit - position, count);
		while (true) {
			System.arraycopy(buffer, position, bytes, offset, copyCount);
	...
	public int readVarInt (boolean optimizePositive) throws KyroException {
	...
	public boolean canReadInt () throws KyroException {
	...
	public boolean canReadLong () throws KyroException {
	...
	public float readFloat (float precision, boolean optimizePositive) throws KyroException {
	...
	public int readShortUnsigned () throws KyroException {
		require(2);
	...
	public long readVarLong (boolean optimizePositive) throws KyroException {
	...
	public double readDouble (double precision, boolean optimizePositive) throws KyroException {
	...
	public int[] readInts (int length, boolean optimizePositive) throws KyroException {
	...
	public long[] readLongs (int length, boolean optimizePositive) throws KyroException {
	...
	/** Bulk input of an int array. */
	public int[] readInts (int length) throws KyroException {
		int[] array = new int[length];
		for (int i = 0; i < length; i++)
			array[i] = readInt();
		return array;
	...
	/** Bulk input of a long array. */
	public long[] readLongs (int length) throws KyroException {
		long[] array = new long[length];
		for (int i = 0; i < length; i++)
			array[i] = readLong();
		return array;
	...
	public float[] readFloats (int length) throws KyroException {
	...
	public short[] readShorts (int length) throws KyroException {
	...
	public char[] readChars (int length) throws KyroException {
	...
	public double[] readDoubles (int length) throws KyroException {
