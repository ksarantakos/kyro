...
public final class UnsafeMemoryOutput extends ByteBufferOutput {
	...
	/** Writes a 4 byte int. */
	final public void writeInt (int value) throws KyroException {
		require(4);
	...
	final public void writeFloat (float value) throws KyroException {
		require(4);
	...
	final public void writeShort (int value) throws KyroException {
		require(2);
	...
	final public void writeLong (long value) throws KyroException {
		require(8);
		unsafe().putLong(bufaddress + position, value);
		position += 8;
	}

	final public void writeByte (int value) throws KyroException {
	...
	final public void writeBoolean (boolean value) throws KyroException {
		super.niobuffer.position(position);
		super.writeBoolean(value);
	}

	/** Writes a 2 byte char. */
	final public void writeChar (char value) throws KyroException {
		super.niobuffer.position(position);
		super.writeChar(value);
	}

	/** Writes an 8 byte double. */
	final public void writeDouble (double value) throws KyroException {
		require(8);
	...
	final public int writeInt (int value, boolean optimizePositive) throws KyroException {
		if (!varIntsEnabled) {
			writeInt(value);
			return 4;
		} else
	...
	final public int writeLong (long value, boolean optimizePositive) throws KyroException {
		if (!varIntsEnabled) {
			writeLong(value);
			return 8;
		} else
	...
	final public int writeVarInt (int val, boolean optimizePositive) throws KyroException {
		long value = val;
	...
	final public int writeVarLong (long value, boolean optimizePositive) throws KyroException {
	...
	final public void writeInts (int[] object, boolean optimizePositive) throws KyroException {
		if (!varIntsEnabled) {
	...
	final public void writeLongs (long[] object, boolean optimizePositive) throws KyroException {
		if (!varIntsEnabled) {
	...
	final public void writeInts (int[] object) throws KyroException {
		int bytesToCopy = object.length << 2;
		writeBytes(object, intArrayBaseOffset, 0, bytesToCopy);
	}

	final public void writeLongs (long[] object) throws KyroException {
		int bytesToCopy = object.length << 3;
		writeBytes(object, longArrayBaseOffset, 0, bytesToCopy);
	}

	final public void writeFloats (float[] object) throws KyroException {
		int bytesToCopy = object.length << 2;
		writeBytes(object, floatArrayBaseOffset, 0, bytesToCopy);
	}

	final public void writeShorts (short[] object) throws KyroException {
		int bytesToCopy = object.length << 1;
		writeBytes(object, shortArrayBaseOffset, 0, bytesToCopy);
	}

	final public void writeChars (char[] object) throws KyroException {
		int bytesToCopy = object.length << 1;
		writeBytes(object, charArrayBaseOffset, 0, bytesToCopy);
	}

	final public void writeDoubles (double[] object) throws KyroException {
		int bytesToCopy = object.length << 3;
	 ...
	 * @param offset
	 * @param count */
	final public void writeBytes (Object obj, long offset, long count) throws KyroException {
		writeBytes(obj, 0, offset, count);
	}

	/*** Output count bytes from a memory region starting at the given #{offset} inside the in-memory representation of obj object.
	 * The destination is defined by its address */
	final private void writeBytes (Object srcArray, long srcArrayTypeOffset, long srcOffset, long count) throws KyroException {
