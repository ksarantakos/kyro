...
public class Output extends OutputStream {
	...
	protected boolean require (int required) throws KyroException {
		if (capacity - position >= required) return false;
		if (required > maxCapacity)
			throw new KyroException("Buffer overflow. Max capacity: " + maxCapacity + ", required: " + required);
		flush();
		while (capacity - position < required) {
			if (capacity == maxCapacity)
				throw new KyroException("Buffer overflow. Available: " + (capacity - position) + ", required: " + required);
			// Grow buffer.
	...
	/** Writes a byte. */
	public void write (int value) throws KyroException {
		if (position == capacity) require(1);
		buffer[position++] = (byte)value;
	}

	/** Writes the bytes. Note the byte[] length is not written. */
	public void write (byte[] bytes) throws KyroException {
		if (bytes == null) throw new IllegalArgumentException("bytes cannot be null.");
		writeBytes(bytes, 0, bytes.length);
	}

	/** Writes the bytes. Note the byte[] length is not written. */
	public void write (byte[] bytes, int offset, int length) throws KyroException {
		writeBytes(bytes, offset, length);
	}

	// byte

	public void writeByte (byte value) throws KyroException {
		if (position == capacity) require(1);
		buffer[position++] = value;
	}

	public void writeByte (int value) throws KyroException {
		if (position == capacity) require(1);
		buffer[position++] = (byte)value;
	}

	/** Writes the bytes. Note the byte[] length is not written. */
	public void writeBytes (byte[] bytes) throws KyroException {
		if (bytes == null) throw new IllegalArgumentException("bytes cannot be null.");
		writeBytes(bytes, 0, bytes.length);
	}

	/** Writes the bytes. Note the byte[] length is not written. */
	public void writeBytes (byte[] bytes, int offset, int count) throws KyroException {
		if (bytes == null) throw new IllegalArgumentException("bytes cannot be null.");
	...
	public void writeInt (int value) throws KyroException {
		require(4);
	 ...
	 *           inefficient (5 bytes). */
	public int writeInt (int value, boolean optimizePositive) throws KyroException {
	 ...
	 * @param optimizePositive If true, small positive numbers will be more efficient (1 byte) and small negative numbers will be
	 *           inefficient (5 bytes). */
	public int writeVarInt (int value, boolean optimizePositive) throws KyroException {
	...
	public void writeString (String value) throws KyroException {
		if (value == null) {
	 ...
	 * @param value May be null. */
	public void writeString (CharSequence value) throws KyroException {
		if (value == null) {
			writeByte(0x80); // 0 means null, bit 8 means UTF8.
			return;
		}
	 ...
	 * {@link Input#readStringBuilder()}.
	 * @param value May be null. */
	public void writeAscii (String value) throws KyroException {
		if (value == null) {
			writeByte(0x80); // 0 means null, bit 8 means UTF8.
			return;
		}
	...
	private void writeAscii_slow (String value, int charCount) throws KyroException {
		byte[] buffer = this.buffer;
		int charIndex = 0;
	...
	public void writeFloat (float value) throws KyroException {
	 ...
	 * @param optimizePositive If true, small positive numbers will be more efficient (1 byte) and small negative numbers will be
	 *           inefficient (5 bytes). */
	public int writeFloat (float value, float precision, boolean optimizePositive) throws KyroException {
	...
	public void writeShort (int value) throws KyroException {
		require(2);
		buffer[position++] = (byte)(value >>> 8);
		buffer[position++] = (byte)value;
	}
	...
	public void writeLong (long value) throws KyroException {
		require(8);
		byte[] buffer = this.buffer;
	 ...
	 * @param optimizePositive If true, small positive numbers will be more efficient (1 byte) and small negative numbers will be
	 *           inefficient (9 bytes). */
	public int writeLong (long value, boolean optimizePositive) throws KyroException {
	 ...
	 * @param optimizePositive If true, small positive numbers will be more efficient (1 byte) and small negative numbers will be
	 *           inefficient (9 bytes). */
	public int writeVarLong (long value, boolean optimizePositive) throws KyroException {
	...
	public void writeBoolean (boolean value) throws KyroException {
		if (position == capacity) require(1);
	...
	public void writeChar (char value) throws KyroException {
		require(2);
		buffer[position++] = (byte)(value >>> 8);
		buffer[position++] = (byte)value;
	}
	...
	public void writeDouble (double value) throws KyroException {
	 ...
	 * @param optimizePositive If true, small positive numbers will be more efficient (1 byte) and small negative numbers will be
	 *           inefficient (9 bytes). */
	public int writeDouble (double value, double precision, boolean optimizePositive) throws KyroException {
	...
	public void writeInts (int[] object, boolean optimizePositive) throws KyroException {
		for (int i = 0, n = object.length; i < n; i++)
			writeInt(object[i], optimizePositive);
	}

	/** Bulk output of an long array. */
	public void writeLongs (long[] object, boolean optimizePositive) throws KyroException {
		for (int i = 0, n = object.length; i < n; i++)
			writeLong(object[i], optimizePositive);
	}

	/** Bulk output of an int array. */
	public void writeInts (int[] object) throws KyroException {
		for (int i = 0, n = object.length; i < n; i++)
			writeInt(object[i]);
	}

	/** Bulk output of an long array. */
	public void writeLongs (long[] object) throws KyroException {
		for (int i = 0, n = object.length; i < n; i++)
			writeLong(object[i]);
	}

	/** Bulk output of a float array. */
	public void writeFloats (float[] object) throws KyroException {
		for (int i = 0, n = object.length; i < n; i++)
			writeFloat(object[i]);
	}

	/** Bulk output of a short array. */
	public void writeShorts (short[] object) throws KyroException {
		for (int i = 0, n = object.length; i < n; i++)
			writeShort(object[i]);
	}

	/** Bulk output of a char array. */
	public void writeChars (char[] object) throws KyroException {
		for (int i = 0, n = object.length; i < n; i++)
			writeChar(object[i]);
	}

	/** Bulk output of a double array. */
	public void writeDoubles (double[] object) throws KyroException {
		for (int i = 0, n = object.length; i < n; i++)
