...
public final class UnsafeInput extends Input {
	...
	/** {@inheritDoc} */
	final public int[] readInts (int length) throws KyroException {
		int bytesToCopy = length << 2;
		int[] array = new int[length];
		readBytes(array, intArrayBaseOffset, 0, bytesToCopy);
		return array;
	...
	/** {@inheritDoc} */
	final public long[] readLongs (int length) throws KyroException {
		int bytesToCopy = length << 3;
		long[] array = new long[length];
		readBytes(array, longArrayBaseOffset, 0, bytesToCopy);
		return array;
	...
	final private void readBytes (Object dstArray, long dstArrayTypeOffset, long offset, int count) throws KyroException {
