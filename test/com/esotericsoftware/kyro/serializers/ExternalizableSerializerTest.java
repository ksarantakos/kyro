...
import com.esotericsoftware.kyro.KryoTestCase;
import com.esotericsoftware.kyro.io.Input;
import com.esotericsoftware.kyro.io.Output;
import com.esotericsoftware.kyro.serializers.DefaultSerializers;
import com.esotericsoftware.kyro.serializers.ExternalizableSerializer;
...
public class ExternalizableSerializerTest extends KryoTestCase {
	 public void testRegister () {
		  kyro.register(TestClass.class, new ExternalizableSerializer());
		  kyro.register(String.class, new DefaultSerializers.StringSerializer());
	 ...
	 public void testDefault () {
		  ...
		  kyro.addDefaultSerializer(Externalizable.class, new ExternalizableSerializer());
		  TestClass test = new TestClass();
		  test.stringField = "fubar";
		  test.intField = 54321;
	 ...
	 public void testReadResolve () {
		  kyro.setRegistrationRequired(false);
		  kyro.addDefaultSerializer(Externalizable.class, ExternalizableSerializer.class);
		  ...
		  Object result = kyro.readClassAndObject(input);
		  input.close();
	 ...
	 public void testTwoClasses () {
		  ...
		  list.add(test2);
		  Output output = new Output(1024);
		  kyro.writeClassAndObject(output, list);
		  output.flush();

		  Input input = new Input(output.getBuffer());
		  List result = (List)kyro.readClassAndObject(input);
		  input.close();
