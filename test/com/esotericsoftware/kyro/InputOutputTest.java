...
import com.esotericsoftware.kyro.io.ByteBufferInputStream;
import com.esotericsoftware.kyro.io.ByteBufferOutput;
import com.esotericsoftware.kyro.io.ByteBufferOutputStream;
...
public class InputOutputTest extends KryoTestCase {
	...
	public void testZeroLengthOutputs() throws Exception {
		...
		kyro.writeClassAndObject(output, "Test string");

		Output byteBufferOutput = new ByteBufferOutput(0, 10000);
		kyro.writeClassAndObject(byteBufferOutput, "Test string");
	}
}
