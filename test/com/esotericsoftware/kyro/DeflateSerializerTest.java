...
import com.esotericsoftware.kyro.serializers.DeflateSerializer;
...
public class DeflateSerializerTest extends KryoTestCase {
	public void testString () {
		kyro.register(String.class, new DeflateSerializer(new StringSerializer()));
		roundTrip(15, 15, "abcdefabcdefabcdefabcdefabcdefabcdefabcdef");
	}

	public void testGraph () {
		kyro.register(Message.class);
		kyro.register(MessageType.class);
		kyro.register(ServerPhysicsUpdate.class, new DeflateSerializer(kyro.getDefaultSerializer(ServerPhysicsUpdate.class)));
